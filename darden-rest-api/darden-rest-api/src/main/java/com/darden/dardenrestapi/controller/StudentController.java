...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(11, "Maha", "UI"));
        students.add(new Student(2, "Dhatri", "MS"));
        students.add(new Student(3, "Sushma", "UI"));
        students.add(new Student(4, "Rajith", "MS"));
        return ResponseEntity.ok(students);
    }
    // http://localhost:8080/students/11/Maha/UI
 ...
 // Spring boot REST API with Request Param
    //  http://localhost:8080/students/query?id=11&firstName=Maha&role=UI
    @GetMapping("query")
